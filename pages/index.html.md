...
1. **Editor** — compose pages from sections/blocks without shipping a separate headless CMS UI for every change.
2. **CMS runtime** — stores content and renders it inside your Rails views and layouts.
