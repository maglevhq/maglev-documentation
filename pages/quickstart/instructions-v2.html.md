...
{% description %}
Instructions to install the single-site version (or MIT version) of Maglev v2
{% enddescription %}

> Want to try the beta? Check out the [Quick start (v3 beta)](./instructions-v3).
...
- Node 20+ (required for the Maglev 2.x asset build)
{% endhint %}
